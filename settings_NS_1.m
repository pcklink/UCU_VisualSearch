...
STIM.TrialType(1).TargetSize = [2 2.66]; % [w h] dva keep [1 1.33] aspect ratio
STIM.TrialType(1).Distractor = 'neutral';
STIM.TrialType(1).DistractorSize = [2 2.66];
...
STIM.TrialType(2).TargetSize = [2 2.66]; % dva
STIM.TrialType(2).Distractor = 'neutral';
STIM.TrialType(2).DistractorSize = [2 2.66];
...
STIM.Block(1).TextStory = STORY.anger(1).text;
...
STIM.Block(2).TextStory = STORY.happy(1).text;
